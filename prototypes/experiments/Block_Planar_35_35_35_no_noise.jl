...
T = generateSurfaceTensor(eigenX, eigenY, eigenZ, 0.5 ;type="uniform")      
...
stratificationTest(T,"block_planar_tensor_35_35_35"; ratio=1000,rounds=100,control=true,noise=0,relsize=0.00001,toprint=10,type="normal")
