...
T = generateSurfaceTensor(eigenX, eigenY, eigenZ, 5 ;type="uniform")      
...
stratificationTest(T,"planar_tensor_30_35_40"; ratio=1000,rounds=70,control=true,noise=80,relsize=0.00001,toprint=10,type="normal")
