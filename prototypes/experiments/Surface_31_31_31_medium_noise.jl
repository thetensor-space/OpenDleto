...
T = generateSurfaceTensor(eigenX, eigenY, eigenZ, 7 ;type="uniform")      
...
stratificationTest(T,"surface_tensor_31_31_31"; ratio=1000,rounds=70,control=true,noise=40,relsize=0.000001,toprint=10,type="normal")
